        ...
        <div id="mainContent" class="flex-1 ml-64 flex flex-col">
            ...
            <main class="p-6 flex-1 overflow-y-auto">
                <div class="bg-white rounded-lg shadow-md overflow-hidden">
                    ...
                    <!-- Form Content -->
                    <form method="POST" action="blotteradmin.php" id="blotterForm" class="p-8">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const barangayBounds = L.polygon([
                ...
                [14.567054, 121.080678],  // Northeast 2
                [14.56681990344867, 121.08126662850269],  // East 1
                [14.566000798161731, 121.08067141330856],  // East 2
                [14.565260946901033, 121.08098546377418],  // East 3
                [14.565303991454742, 121.08142777985327],  // East 4
                [14.56542990915367, 121.08181530848218],  // Southeast 1
                [14.565780870871203, 121.08251009195259],  // Southeast 2
                [14.56615326475455, 121.08288931639657],  // Southeast 3
                [14.566447964513838, 121.08362838891226],  // South 1
                [14.566155943854573, 121.08408235102041],  // South 2
                [14.565397759954498, 121.08439237394583],  // South 3
                [14.564885961076987, 121.08441203838785],  // South 4
                [14.564186584109882, 121.08461618031544],
                [14.564105042252416, 121.08487864854511],
                [14.564123859605909, 121.08540358493033],
                [14.564576644924687, 121.08723854461778],
                [14.56479800870271, 121.08784151692676],
                [14.563635672955709, 121.09060187622569],
                [14.562517332740459, 121.09040092603516],
                [14.56218885123583, 121.09401893982965],
                [14.561216375425687, 121.09434548388927],
                [14.56235903406178, 121.09793746854517],
                [14.563769115282183, 121.09602844173504],
                [14.565179187486644, 121.09627962947322],
                [14.56515487600367, 121.09653081743348],
                [14.569326841850907, 121.09663127030743],
                [14.571041426939484, 121.09432824495245],
                [14.571898714482394, 121.0877734804806]
            ], {
                color: '#1e40af',
                weight: 3,
                opacity: 0.8,
